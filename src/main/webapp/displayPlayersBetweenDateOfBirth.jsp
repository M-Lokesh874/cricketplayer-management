...
<head>
<meta charset="UTF-8">
<title>Display players between date of birth</title>
<link rel="stylesheet"
...
<body>
	...
	<br>
	<div align="center">
		<h1>Display players between date of birth</h1>
		<form action="displayplayersbetweendateofbirth" method="post">
			Start date:<input type="date" name="startdate"> End date :<input
