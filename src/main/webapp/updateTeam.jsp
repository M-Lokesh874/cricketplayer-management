...
<body>
	...
	<form action="updateteambyid" method="post">
		...
		<table class="table bg-info">
			<tr>
				<td>Id of team</td>
				<td><input name="id" value=<%=cricketTeam.getId()%>
					type="text" readonly></td>
			</tr>
			<tr>
				<td>Name:</td>
				<td><input type="text" name="name"
					value=<%=cricketTeam.getName()%>></td>
			</tr>

			<tr>
				<td>Total match :</td>
				<td><input type="number" name="totalmatch"
					value=<%=cricketTeam.getTotalMatch()%>></td>
			</tr>

			<tr>
				<td>Won :</td>
				<td><input type="number" name="won"
					value=<%=cricketTeam.getWon()%>></td>
			</tr>


			<tr>
				<td>Lost :</td>
				<td><input type="number" name="lost"
					value=<%=cricketTeam.getLost()%>></td>
			</tr>
	...
	%>
	<%
	if (cricketTeam1.getName() != cricketTeam.getName() || cricketTeam1.getTotalMatch() != cricketTeam.getTotalMatch()
			|| cricketTeam1.getWon() != cricketTeam.getWon() || cricketTeam1.getLost() != cricketTeam.getWon()) {
	%>
